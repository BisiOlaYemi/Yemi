  ...
  return (
    <div className=" rounded-lg text-white p-8 relative mt-6">
      ...
      <div className="mb-8">
        ...
        <h2 className="text-2xl font-bold mb-4 relative z-10"><span className='text-indigo-600'>Skills</span></h2>
        <p>
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-300">Jan 2023 - June 2023</p>
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-300">Mar 2020 - Nov 2022</p>
        <ul className="list-disc list-inside">
          <li>
      ...
      <div className="mb-8">
        <div className="thread" />
        <h2 className="text-2xl font-bold mb-4 relative z-10"><span className='text-indigo-600'>Education</span></h2>
        <p>
