...
const experiences = [
  ...
  },
  {
    ...
    company: 'Careerhaven',
    period: '2022 - 2023',
    description: 'Developed front-end components using JavaScript  (Next.js, React.js) using TypeScript. Designed and implement back-end services using Node.js'
  },
  {
    title: 'Software Developer',
    company: 'Readycars NG',
    period: '2020 - 2022',
    description: 'Facilitated the creation of user stories and web development lifecycle, with subsequent hands-on deliverable of a Car hire application for the company.'
  }
]
  ...
  return (
    <div className="min-h-screen text-white py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto">
        ...
        >
          I am priviledged to have worked as:
        </motion.h3>
          ...
          {experiences.map((experience, index) => (
            ...
            >
              ...
              <div className={`order-1 bg-gray-800 rounded-lg shadow-xl w-5/12 px-6 py-4`}>
                <h3 className="mb-3 font-bold bg-gradient-to-r from-purple-500 to-amber-500 text-transparent bg-clip-text text-xl">{experience.title}</h3>
                <h4 className="mb-3 font-semibold text-lg text-gray-400">{experience.company} <span className="text-sm">({experience.period})</span></h4>
                <p className="text-sm leading-snug tracking-wide text-gray-300 text-opacity-100">{experience.description}</p>
              </div>
            </motion.div>
          ))}
        </div>
